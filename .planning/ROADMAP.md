...
Plans:
- [ ] 11-01-PLAN.md — Migration 132 + ipc-contract DTOs + EntitlementAction extension + ResearchService + SearchProviderService + static ratchets (wave 1)
- [ ] 11-02-PLAN.md — research.ts IPC handlers + index.ts registration + transcripts.ts hook + renderer UI components + route + Integrations key rows (wave 2)
